...
exports.exampleCommentsAnalytics = exampleCommentsAnalytics;
exports.examplePurchaseIntent = examplePurchaseIntent;
exports.exampleSocialListening = exampleSocialListening;
exports.exampleWebhooks = exampleWebhooks;
exports.exampleErrorHandling = exampleErrorHandling;
exports.exampleTestConnection = exampleTestConnection;
exports.runAllExamples = runAllExamples;
const index_1 = require("../index");
// Initialize the InsightIQ client
const client = new index_1.InsightIQClient({
...
async function exampleCommentsAnalytics() {
    ...
    try {
        ...
        const relevantComments = await client.commentsAnalytics.getComments(analysisRequest.id, {
            type: index_1.CommentType.RELEVANT_COMMENTS,
            limit: 50,
            offset: 0
        });
        ...
        const irrelevantComments = await client.commentsAnalytics.getComments(analysisRequest.id, {
            type: index_1.CommentType.IRRELEVANT_COMMENTS,
            limit: 10,
            offset: 0
        });
...
async function exampleSocialListening() {
    ...
    try {
        // 1. Search by keyword
        const keywordSearch = await client.socialListening.searchByKeyword('69dc0dd2-b78e-4013-b0d6-5693bb48b548', // Instagram platform ID
        ...
        // 3. Search by hashtag
        const hashtagSearch = await client.socialListening.searchByHashtag('69dc0dd2-b78e-4013-b0d6-5693bb48b548', 'AI', // without # prefix
        {
            itemsLimit: 50,
        ...
        // 4. Search by mention
        const mentionSearch = await client.socialListening.searchByMention('69dc0dd2-b78e-4013-b0d6-5693bb48b548', 'openai', // without @ prefix
        {
            itemsLimit: 25
        });
        console.log('Mention search created:', mentionSearch.id);
        // 5. TikTok audio track search example
        const audioSearch = await client.socialListening.searchByAudioTrack('tiktok-platform-id', {
            title: 'Bad at Love',
...
async function exampleWebhooks() {
    ...
    try {
        ...
        const webhook = await client.webhooks.create({
            ...
            events: [
                index_1.WebhookEvent.PROFILES_ADDED,
                index_1.WebhookEvent.CONTENTS_ADDED,
                index_1.WebhookEvent.CONTENTS_UPDATED
            ],
        ...
        const updatedWebhook = await client.webhooks.update(webhook.id, {
            ...
            events: [
                ...webhook.events,
                index_1.WebhookEvent.ACCOUNTS_CONNECTED,
                index_1.WebhookEvent.PROFILES_ADDED
            ],
...
async function exampleErrorHandling() {
    ...
    try {
        ...
        const badClient = new index_1.InsightIQClient({
            username: 'invalid',
            password: 'invalid',
            sandbox: true
        });
