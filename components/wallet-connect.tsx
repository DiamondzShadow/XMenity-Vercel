      ...
      <div className={className}>
        <Card className="w-full max-w-md mx-auto">
          <CardHeader>
            ...
            <CardDescription>Sign a message to authenticate your wallet</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button onClick={handleAuthenticate} disabled={isAuthenticating || isSigningMessage} className="flex-1">
              ...
              <Button variant="outline" onClick={handleDisconnect} disabled={isAuthenticating}>
                Disconnect
              </Button>
            </div>
          </CardContent>
      ...
      <div className={className}>
        <Card className="w-full max-w-md mx-auto">
          <CardHeader>
            ...
            {user.twitterUsername && <CardDescription>@{user.twitterUsername}</CardDescription>}
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
    ...
    <div className={className}>
      <div className="flex items-center space-x-2">
        {connectors.map((connector) => (
          <Button key={connector.uid} variant="outline" onClick={() => connect({ connector })} disabled={isPending}>
